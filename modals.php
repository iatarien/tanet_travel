<!-- Modal Order Form -->
      <div id="buy-ticket-modal1" class="modal fade">
        <div class="modal-dialog" role="document" style="max-width: 800px;">
          <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body">
              ...
              <?php 
              if ($lang == "fr.php") { ?>
                <p style="text-align: justify; margin: 0;">&emsp;&emsp;Tanet Voyages vous offre la possibilité de vivre des adventures inoubliables au coeur du desert de Tadrart. </p>
              <?php  }else {  ?>
                <p style="text-align: justify; margin: 0;">&emsp;&emsp;Tanet Voyages offers you the opportunity to experience unforgettable adventures in the heart of the Tadrart desert.</p>
              <?php  }  ?>
...
<!-- Modal Order Form -->
      <div id="buy-ticket-modal3" class="modal fade">
        <div class="modal-dialog" role="document" style="max-width: 800px;">
          <div class="modal-content">
            <div class="modal-header" style="display: block;">
              <h4 class="modal-title" id="modal-title" style="text-align: center;">
